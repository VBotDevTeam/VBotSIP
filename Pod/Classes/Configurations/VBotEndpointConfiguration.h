...
@interface VBotEndpointConfiguration : NSObject
 ...
 */
@property (nonatomic) VBotStunConfiguration * _Nullable stunConfiguration;

/**
 * The IP change configuration, what happens when an ip address changes.
 */
@property (nonatomic) VBotIpChangeConfiguration * _Nullable ipChangeConfiguration;

/**
 * The codecs that are going to be used by the endpoint
 */
@property (nonatomic) VBotCodecConfiguration * _Nullable codecConfiguration;
