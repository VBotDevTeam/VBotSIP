 ...
 */
typedef NS_ENUM(NSUInteger, VBotStunUse) {
    /**
     * Follow the default setting in the global pjsua_config.
     */
    VBotStunUseDefault = PJSUA_STUN_USE_DEFAULT,
    /**
     * Disable STUN. If STUN is not enabled in the global pjsua_config,
     * this setting has no effect.
     */
    VBotStunUseDisable = PJSUA_STUN_USE_DISABLED,
    /**
     ...
     * transport.
     */
    VBotStunUseRetryOnFailure = PJSUA_STUN_RETRY_ON_FAILURE
};

/**
 *  Enum which specifies the contact rewrite method
 */
typedef NS_ENUM(NSUInteger, VBotContactRewriteMethod) {
    /**
     ...
     */
    VBotContactRewriteMethodUnregister = PJSUA_CONTACT_REWRITE_UNREGISTER,
    /**
     ...
     */
    VBotContactRewriteMethodNoUnregister = PJSUA_CONTACT_REWRITE_NO_UNREG,
    /**
    ...
    VBotContactRewriteMethodAlwaysUpdate = PJSUA_CONTACT_REWRITE_ALWAYS_UPDATE
};

@interface VBotAccountConfiguration : NSObject
 ...
 */
@property (nonatomic) VBotContactRewriteMethod contactRewriteMethod;
...
@property (nonatomic) VBotTurnConfiguration * _Nullable turnConfiguration;

@property (nonatomic) VBotIceConfiguration * _Nullable iceConfiguration;
